              ...
              <ul className="pagination" style={{marginTop:10}} >
                {pages.map((page, index) => {
                  if (page === LEFT_PAGE)
                    return (
                      <li key={index} className="page-item">
                        <a className="page-link " href="#" aria-label="Previous" onClick={this.handleMoveLeft} style={{width:40,textAlign:'center'}}>
                  ...
                  if (page === RIGHT_PAGE)
                    return (
                      <li key={index} className="page-item">
                        <a className="page-link " href="#" aria-label="Next" onClick={this.handleMoveRight} style={{width:40,textAlign:'center'}}>
